...
// I have laerned
// (1) There are two types of functoins
// (a) void       (b) return

// (2) Return Functions can be of different types such as String, int and num etc

// (3) Parameters, at a same time can also be of different types like functions.cd